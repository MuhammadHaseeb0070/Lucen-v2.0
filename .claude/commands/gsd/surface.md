...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `E:/Lucen/Lucen-v2.3 fresh/.claude/.gsd-surface.json`
(sibling to `E:/Lucen/Lucen-v2.3 fresh/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `E:/Lucen/Lucen-v2.3 fresh/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`E:/Lucen/Lucen-v2.3 fresh/.claude/skills`).
...
`E:/Lucen/Lucen-v2.3 fresh/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `E:/Lucen/Lucen-v2.3 fresh/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `E:/Lucen/Lucen-v2.3 fresh/.claude/.gsd-surface.json`
Install profile marker: `E:/Lucen/Lucen-v2.3 fresh/.claude/.gsd-profile`
Skill dirs: `E:/Lucen/Lucen-v2.3 fresh/.claude/skills/gsd-*/`
Engine module: `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
