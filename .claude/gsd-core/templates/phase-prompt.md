...
<!-- For checkpoint task examples and patterns, see @E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/checkpoints.md -->
...
See `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
