...
```
Agent(
  prompt="Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/SECURITY.md`
