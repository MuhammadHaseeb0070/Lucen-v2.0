...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-ui-checker.md for instructions.
