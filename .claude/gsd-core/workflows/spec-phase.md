...
```bash
INIT=$(node "E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/spec.md.
