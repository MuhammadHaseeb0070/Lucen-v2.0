...
<required_reading>
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/ai-frameworks.md
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.claude/agents/gsd-eval-planner.md for instructions.
