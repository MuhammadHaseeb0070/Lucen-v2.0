...
<reference>
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/user-profiling.md` to load:
