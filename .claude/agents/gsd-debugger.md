...
<required_reading>
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/Lucen/Lucen-v2.3 fresh/.claude
                  → checks E:/Lucen/Lucen-v2.3 fresh/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core
                  → writes to E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/hooks/
...
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/common-bug-patterns.md
