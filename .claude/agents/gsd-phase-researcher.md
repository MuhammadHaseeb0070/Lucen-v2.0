...
@E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/references/thinking-models-research.md
...
```bash
node "E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
