...
Use template from `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/UI-SPEC.md`
