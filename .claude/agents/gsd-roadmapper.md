...
Reference full template: `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Lucen/Lucen-v2.3 fresh/.claude/gsd-core/templates/state.md`.
