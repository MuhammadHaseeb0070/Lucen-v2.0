...
- [ ] **Phase 1: Foundation + Finance-Critical Fixes** — Test infrastructure (Vitest + Playwright), shared types package, fix finishReason billing drift (BUG-05) and JWT expiry mid-stream (SEC-06), initial unit tests
...
|-------|----------------|--------|-----------|
| 1. Foundation + Finance-Critical Fixes | 0/0 | Not started | - |
