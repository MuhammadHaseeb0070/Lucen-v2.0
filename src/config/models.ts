...
/** Grace passes when a stream ends with `length` / truncated — finish the thought without raising per-call caps. */
export const CONTINUATION_MAX_CHUNKS_ARTIFACT = envInt('VITE_CONTINUATION_MAX_CHUNKS_ARTIFACT', 4);
export const CONTINUATION_MAX_CHUNKS_CHAT = envInt('VITE_CONTINUATION_MAX_CHUNKS_CHAT', 2);
export const ABSOLUTE_OUTPUT_CEILING = envInt('VITE_ABSOLUTE_OUTPUT_CEILING', 16000);
export const CHAT_OUTPUT_CEILING = envInt('VITE_CHAT_OUTPUT_CEILING', 1400);
export const ARTIFACT_OUTPUT_CEILING = envInt('VITE_ARTIFACT_OUTPUT_CEILING', 16000);
