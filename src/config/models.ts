...
export const CONTINUATION_MAX_CHUNKS_ARTIFACT = envInt('VITE_CONTINUATION_MAX_CHUNKS_ARTIFACT', 2);
export const CONTINUATION_MAX_CHUNKS_CHAT = envInt('VITE_CONTINUATION_MAX_CHUNKS_CHAT', 2);
export const ABSOLUTE_OUTPUT_CEILING = envInt('VITE_ABSOLUTE_OUTPUT_CEILING', 6000);
