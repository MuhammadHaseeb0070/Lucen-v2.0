...
export const ABSOLUTE_OUTPUT_CEILING = envInt('VITE_ABSOLUTE_OUTPUT_CEILING', 32000);
export const CHAT_OUTPUT_CEILING = envInt('VITE_CHAT_OUTPUT_CEILING', 32000);
export const ARTIFACT_OUTPUT_CEILING = envInt('VITE_ARTIFACT_OUTPUT_CEILING', 32000);
