...
- Usage: Reference from command with `@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to E:/Lucen/Lucen-v2.3 fresh/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/Lucen/Lucen-v2.3 fresh/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
