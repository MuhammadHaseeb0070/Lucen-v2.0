...
INSTALL_JS_GLOBAL="E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
