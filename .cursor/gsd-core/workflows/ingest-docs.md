...
```bash
INIT=$(node "E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/bin/gsd-tools.cjs" commit \
