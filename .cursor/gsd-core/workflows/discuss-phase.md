...
<required_reading>
@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/references/domain-probes.md
@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/references/gate-prompts.md
@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
