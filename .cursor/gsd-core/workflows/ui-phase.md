...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/Lucen/Lucen-v2.3 fresh/.cursor/agents/gsd-ui-checker.md for instructions.
