...
<template>
@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/workflows/transition.md`.
...
- Follow @E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/workflows/diagnose-issues.md
