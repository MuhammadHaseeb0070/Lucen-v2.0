...
```
Agent(
  prompt="Read E:/Lucen/Lucen-v2.3 fresh/.cursor/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/VALIDATION.md`
