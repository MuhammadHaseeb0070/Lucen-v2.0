...
Use template from `E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/UI-SPEC.md`.
...
Read template: `E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/UI-SPEC.md`
