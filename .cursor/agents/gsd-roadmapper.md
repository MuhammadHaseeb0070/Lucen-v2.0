...
Reference full template: `E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/Lucen/Lucen-v2.3 fresh/.cursor/gsd-core/templates/state.md`.
